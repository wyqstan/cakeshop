...
<div class="container-fluid">
	...
	<br><br>
	<form class="form-horizontal" action="http://localhost/shopping_online/admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-6"><img src="http://localhost/shopping_online${g.cover }" width="100" height="100"/>
				<input type="file" name="cover"  id="input_file">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">详情图片1</label> 
			<div class="col-sm-6"><img src="http://localhost/shopping_online${g.image1}" width="100" height="100"/>
				<input type="file" name="image1"  id="input_file">推荐尺寸: 500 * 500
			</div>
		</div>
		<div class="form-group">
			<label for="input_file" class="col-sm-1 control-label">详情图片2</label> 
			<div class="col-sm-6"><img src="http://localhost/shopping_online${g.image2}" width="100" height="100"/>
